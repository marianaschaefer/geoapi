...
PRINT_VERSION_TAG = 'seg-v3-robusto'
...
def processar_segmentacao_completa(output_dir=OUTPUT_DIR, bbox=None):
    ...
    # baixa (função existente; mantém sua lógica)
    msg = baixar_bandas_earthsearch(output_dir=output_dir, bbox=bbox)
    msgs.append(msg if isinstance(msg, str) else str(msg))

    # monta multibanda apenas com as bandas que existem fisicamente
